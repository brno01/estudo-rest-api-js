...
router.get('/:id_categorie', auth.open, CategoriesController.getCategoriesbyID); //Retorna uma categoria específica | Não é necessário autenticar para acessar a rota.
